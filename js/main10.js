...
GameState.prototype.preload = function() {
    ...
    this.game.load.image('vertical','assets/flatblock.png');
    this.game.load.image('horizontal','assets/horizontalblock.png');
...
GameState.prototype.create = function() {
    ...
    var pig = game.add.sprite(450,380,'pig');
    pig.scale.x = 0.05;
    pig.scale.y = 0.05;

    var pig2 = game.add.sprite(490,165,'pig');
    pig2.scale.x = 0.05;
    pig2.scale.y = 0.05;
